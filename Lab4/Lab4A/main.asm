...
.cseg
.org 0x0000
ldi colon,58						; load in ASCII code for zero and the colon
ldi second1,48
ldi second2,48
ldi minute1,48
ldi minute2,48
...
incsec2:						; ten seconds have passed
	ldi second1, 48
	inc second2
	cpi second2, 54				; comapre second number with 6 (ASCII)
	breq incmin1
	rjmp timeset
...
incmin1:							;plus one minute after 60 seconds
	ldi second2, 48
	inc minute1
	cpi minute1, 58					; compare with 10
	breq incmin2
	rjmp timeset

incmin2:						;plus one after 10 minutes passed
	ldi minute1, 48
	inc minute2
	cpi minute2, 54
	breq timereset
